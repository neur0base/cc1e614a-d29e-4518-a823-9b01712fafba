...
export default function WordDetailScreen(
  ...
  const { getThemeColor, getUILabel, getNewComponentID } = useUIContext<
    never,
    never
  >(componentID);
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.pronunciationContainer}>
        ...
        >
          {getUILabel('Play', 'Play')}
        </Button>
        <Icon
          name="fa_volume-up"
          size="normal"
          color={getThemeColor('iconColor', 'textColor')}
        />
      </View>
